...
List<MetaDataProperty> metaDataPropertyFromJson(String str) => List<MetaDataProperty>.from(json.decode(str).map((x) => MetaDataProperty.fromJson(x)));

String metaDataPropertyToJson(List<MetaDataProperty> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class MetaDataProperty {
  ...
  factory MetaDataProperty.fromJson(Map<String, dynamic> json) => MetaDataProperty(
    word: json["word"],
